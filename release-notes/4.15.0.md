...
[v4.11.0](https://github.com/IMMMOBINIUM/telegraf/releases/tag/v4.11.0) introduced support for filters in `Composer::on`, which allowed you to filter updates based on their content.
